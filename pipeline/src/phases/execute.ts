...
const agents: Record<string, AgentDefinition> = {
  worker: {
    description:
      "General-purpose worker agent for reading, writing, editing files, and running commands.",
    prompt:
      "You are a worker agent. Implement the changes described in your instructions carefully and thoroughly.",
  ...
  reviewer: {
    ...
    prompt:
      "You are a code reviewer. Review changes for correctness, style, potential bugs, and Rust conventions.",
