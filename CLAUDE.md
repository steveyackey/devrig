...
When changing configuration options, commands, or features, update **all three** of these:
- `docs/guides/configuration.md` — full reference (source of truth)
- `skill/claude-code/SKILL.md` — condensed reference for the Claude Code skill
